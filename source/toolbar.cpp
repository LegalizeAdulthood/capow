...
TBBUTTON OldToolbar[] = {
    ...
    {BUT_WORLDLARGE, IDM_WORLD, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 0},
    {BUT_VIEWLARGE, IDM_VIEW, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 2},
    {BUT_3DLARGE, IDM_OPENGL, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 11},
    {BUT_USERDIALOGLARGE, IDM_USERDIALOG, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 10},
    //  BUT_ANALOGLARGE,     IDM_ANALOG,     TBSTATE_ENABLED, TBSTYLE_BUTTON,0,0,0,4,
    {BUT_COLORLARGE, IDM_COLOR, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 1},
...
TBBUTTON CursorSection[] = {
    ...
    {0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, {0}, 0, 0},
    {BUT_POINTZOOMLARGE, CUR_PICK, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, {0}, 0, 0},
    {BUT_TOUCHLARGE, CUR_TOUCH, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, {0}, 0, 0},
    {STD_COPY, CUR_ZAP, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, {0}, 0, 0},
    {BUT_GENERATORCUR, CUR_GENERATOR, TBSTATE_ENABLED, TBSTYLE_CHECKGROUP, {0}, 0, 0},
    {0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, {0}, 0, 0},
    {BUT_CLOSE, IDM_CLOSE, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 12},
    {BUT_ACTION_SWAP, IDM_SWAP, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 12},
...
TBBUTTON ChangeSection[] = {
    ...
    {0, 0, TBSTATE_ENABLED, TBSTYLE_SEP, {0}, 0, 0},
    {BUT_CATYPEMENU, IDM_CATYPE_MENU, TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 0},
