...
#define DEFAULTSTATS                                               \
    FALSE /* Use TRUE for debugging to show                        \
...
public:
    ...
    void SetUpLights();
    void SetMaterials(GLfloat ambr, GLfloat ambg, GLfloat ambb, GLfloat difr, GLfloat difg, GLfloat difb, GLfloat specr,
    ...
    void ShowGenerators(BOOL newflag)
    {
        showgeneratorsflag = newflag;
    }
    BOOL ShowGenerators()
    {
        return showgeneratorsflag;
    }

    void ZeroPlane(BOOL newflag)
    {
        zeroplaneflag = newflag;
    }
    BOOL ZeroPlane()
    {
        return zeroplaneflag;
    }

    void MaxPlane(BOOL newflag)
    {
        maxplaneflag = newflag;
    }
    BOOL MaxPlane()
    {
        return maxplaneflag;
