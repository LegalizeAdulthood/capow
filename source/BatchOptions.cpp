...
bool ParseRule(const char *text, capow::BatchRule *rule)
{
    ...
    if (EqualIgnoreCase(text, "CA_WAVE") || EqualIgnoreCase(text, "ALT_CA_WAVE") ||
        EqualIgnoreCase(text, "ALT_CA_WAVE2"))
    {
        *rule = capow::BATCH_RULE_CA_WAVE;
        return true;
    }
    if (EqualIgnoreCase(text, "CA_WAVE2"))
    {
        *rule = capow::BATCH_RULE_CA_WAVE2;
        return true;
    }
    if (EqualIgnoreCase(text, "CA_OSCILLATOR") || EqualIgnoreCase(text, "ALT_CA_OSCILLATOR"))
    {
        *rule = capow::BATCH_RULE_CA_OSCILLATOR;
        return true;
    }
    if (EqualIgnoreCase(text, "CA_DIVERSE_OSCILLATOR") || EqualIgnoreCase(text, "ALT_CA_DIVERSE_OSCILLATOR"))
    {
...
const char *BatchRuleName(BatchRule rule)
{
    ...
    case BATCH_RULE_CA_HEATWAVE2:
        return "CA_HEATWAVE2";
    case BATCH_RULE_CA_WAVE:
        return "CA_WAVE";
    case BATCH_RULE_CA_WAVE2:
        return "CA_WAVE2";
    case BATCH_RULE_CA_OSCILLATOR:
